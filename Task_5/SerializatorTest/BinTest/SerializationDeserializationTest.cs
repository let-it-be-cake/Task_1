...
namespace SerializatorTest.BinTest
{
    public class SerializationDeserializationTest
    {
        ...
        public static IEnumerable<object[]> DataClassTest2()
        {
            ...
            yield return new object[]
            {
                ...
                new string("Bin15.Bin")
            };
        }

        /// <summary>
        /// Testing serializable deserializable functions for a Serializator class in an Bin file
        /// </summary>
        ...
        [Theory]
        [InlineData("Test1", 1, 1.1, "Bin1.Bin")]
        [InlineData("Test100", 100, 10.01, "Bin2.Bin")]
        [InlineData("Test111", 1111, 11.11, "Bin3.Bin")]
        public void Serialize_Deserialize_Generic_To_Bin_File_TestClass1(string field1, int field2, double field3, string path)
        {
            //arrange
            ...
            //act
            serializator.ToBin(expect, path);
            var actual = serializator.FromBin(path);
        ...
        public void Serialize_Deserialize_Generic_To_Bin_File_TestClass2(List<string> field1, int[] field2, string path)
        {
            //arrange
            ...
            //act
            serialization.ToBin(expected, path);
            var actual = serialization.FromBin(path);
        ...
        /// <summary>
        ///  Testing serializable deserializable functions for a Serializator collection generic class in an Bin file
        /// </summary>
        /// <param name="expected">Correc parameters to be serialized</param>
        /// <param name="path">Path to save serializable file</param>
        [Theory]
        [MemberData(nameof(DataClassTest1))]
        public void Serialize_Deserialize_Generic_Collection_To_Bin_File_TestClass1(List<TestClass1> expected, string path)
        {
            //arrange
            ...
            //act
            serialization.ToBin(expected, path);
            var actual = serialization.FromBinCollection(path);
        ...
        public void Serialize_Deserialize_Generic_Collection_To_Bin_File_TestClass2(List<TestClass2> expected, string path)
        {
            //arrange
