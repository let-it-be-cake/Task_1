...
namespace SerializatorTest.XmlTest
{
    public class SerializationDeserializationTest
    {
        ...
        public static IEnumerable<object[]> DataClassTest2()
        {
            ...
            yield return new object[]
            {
                ...
                new string("Xml15.Xml")
            };
        }

        /// <summary>
        /// Testing serializable deserializable functions for a Serializator class in an Xml file
        /// </summary>
        ...
        [Theory]
        [InlineData("Test1", 1, 1.1, "Xml1.Xml")]
        [InlineData("Test100", 100, 10.01, "Xml2.Xml")]
        [InlineData("Test111", 1111, 11.11, "Xml3.Xml")]
        public void Serialize_Deserialize_Generic_To_Xml_File_TestClass1(string field1, int field2, double field3, string path)
        {
            //arrange
            ...
            //act
            serializator.ToXml(expect, path);
            var actual = serializator.FromXml(path);
        ...
        public void Serialize_Deserialize_Generic_To_Xml_File_TestClass2(List<string> field1, int[] field2, string path)
        {
            //arrange
            ...
            //act
            serialization.ToXml(expected, path);
            var actual = serialization.FromXml(path);
        ...
        /// <summary>
        ///  Testing serializable deserializable functions for a Serializator collection generic class in an Xml file
        /// </summary>
        /// <param name="expected">Correc parameters to be serialized</param>
        /// <param name="path">Path to save serializable file</param>
        [Theory]
        [MemberData(nameof(DataClassTest1))]
        public void Serialize_Deserialize_Generic_Collection_To_Xml_File_TestClass1(List<TestClass1> expected, string path)
        {
            //arrange
            ...
            //act
            serialization.ToXml(expected, path);
            var actual = serialization.FromXmlCollection(path);
        ...
        public void Serialize_Deserialize_Generic_Collection_To_Xml_File_TestClass2(List<TestClass2> expected, string path)
        {
            //arrange
