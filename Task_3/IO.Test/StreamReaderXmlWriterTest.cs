...
namespace IO.Test
{
    public class StreamReaderXmlWriterTest
    {
        [Fact]
        public void StreamReadXmlWriterTest_6_objects()
        {
            //arrange
            ...
            var stream1 = new IO.XmlWriter("test4.xml");
            var stream2 = new IO.StreamReader("test4.xml");
        ...
        [Fact]
        public void StreamReadXmlWriterTest_3_objects()
        {
            //arrange
            List<Shape> expected = new List<Shape>();
            ...
            var stream1 = new IO.XmlWriter("test5.xml");
            var stream2 = new IO.StreamReader("test5.xml");
        ...
        [Fact]
        public void StreamReadXmlWriterTest_12_objects()
        {
            //arrange
            List<Shape> expected = new List<Shape>();
            ...
            var stream1 = new IO.XmlWriter("test6.xml");
            var stream2 = new IO.StreamReader("test6.xml");
