...
namespace IO.Test
{
    public class XmlReaderStreamWriterTest
    {
        [Fact]
        public void XmlReadStreamWriteTest_6_objects()
        {
            //arrange
            ...
            var stream1 = new IO.StreamWriter("test7.xml");
            var stream2 = new IO.XmlReader("test7.xml");
        ...
        [Fact]
        public void XmlReadStreamWriteTest_3_objects()
        {
            //arrange
            List<Shape> expected = new List<Shape>();
            ...
            var stream1 = new IO.StreamWriter("test8.xml");
            var stream2 = new IO.XmlReader("test8.xml");
        ...
        [Fact]
        public void XmlReadStreamWriteTest_12_objects()
        {
            //arrange
            List<Shape> expected = new List<Shape>();
            ...
            var stream1 = new IO.StreamWriter("test9.xml");
            var stream2 = new IO.XmlReader("test9.xml");
