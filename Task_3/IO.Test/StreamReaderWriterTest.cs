...
namespace IO.Test
{
    ...
    {
        [Fact]
        public void StreamReadWriteTest_6_objects()
        {
            //arrange
            ...
            var stream1 = new IO.StreamWriter("test1.xml");
            var stream2 = new IO.StreamReader("test1.xml");
        ...
        public void StreamReadWriteTest_3_objects()
        {
            ...
            var stream1 = new IO.StreamWriter("test2.xml");
            var stream2 = new IO.StreamReader("test2.xml");
        ...
        public void StreamReadWriteTest_12_objects()
        {
            ...
            var stream1 = new IO.StreamWriter("test3.xml");
            var stream2 = new IO.StreamReader("test3.xml");
